...
function SingleEvent() {
    ...
    return (
        <div className="single-event">
            <div className="whole_singleEvent">
                    ...
                    <Carousel id="carousel">
                        {singleEvent.event_images?.map((image) => (
                            <Carousel.Item id="carousel-item" interval={2000}>
                                <img id="event_img" src={image} alt="First slide" />
                            </Carousel.Item>
                        ))}
                    </Carousel>
                </div>
                <div className="event-rightDiv">
                    ...
                    <div className="right-downStats">
                        <div>
                            <small className="single_small">Organized By:</small> <br />
                            <span className="single_span">{singleEvent.event_cluster}</span>
                        </div>
                        <div>
                            <small className="single_small">Date:</small> <br />
                            <span className="single_span">{singleEvent.event_date}</span>
                        </div>
                        {singleEvent.no_of_participants != 0 ? (
                            <div>
                                <small className="single_small">No.of Participants:</small>{" "}
                                <br />
                                <span className="single_span">
                                    {singleEvent.no_of_participants}
                                </span>
                            </div>
                        ) : (
                            ""
